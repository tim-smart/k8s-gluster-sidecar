...
exports.notYetBrickIps = exports.volumeInfoBrickIps = exports.notYetPeers = exports.peerStatusIps = exports.peerStatus = exports.run = exports.runMany = undefined;
...
let peerStatusIps = exports.peerStatusIps = (() => {
  var _ref4 = _asyncToGenerator(function* () {
    return (yield parsePeerStatus((yield run('peer', 'status')))).map(function (peer) {
      return peer.Hostname;
    });
  });

  return function peerStatusIps() {
    return _ref4.apply(this, arguments);
  };
})();

let notYetPeers = exports.notYetPeers = (() => {
  var _ref5 = _asyncToGenerator(function* (podIps) {
...
let volumeInfoBrickIps = exports.volumeInfoBrickIps = (() => {
  var _ref6 = _asyncToGenerator(function* (volume) {
...
let notYetBrickIps = exports.notYetBrickIps = (() => {
  var _ref7 = _asyncToGenerator(function* (volume, podIps) {
...
let parseVolumeInfoBrickIps = (() => {
  var _ref9 = _asyncToGenerator(function* (info) {
    const brickHosts = [];
